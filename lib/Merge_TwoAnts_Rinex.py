...
if __name__ == '__main__':
    file_path1 = r'D:\csu\dataset\DROL-GNSS\Obs_pco\DL0200LEO_20243620_PCO.rnx'
    file_path2 = r'D:\csu\dataset\DROL-GNSS\Obs_pco\DL0100LEO_20243620_PCO.rnx'
    merged_outfile = r'D:\csu\dataset\DROL-GNSS\Obs_pco\my_merged_data.rnx'
    header1, data1 = read_rinex_obs(file_path1, system='MIX')
    _, data2 = read_rinex_obs(file_path2, system='MIX')
    merged_data, records = merge_rinex_data_with_strategy1(data1, data2, min_continuous_time=50)
    write_merged_rinex(merged_outfile, header1, merged_data)
